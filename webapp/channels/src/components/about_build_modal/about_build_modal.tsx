...
export default class AboutBuildModal extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    let title = <FormattedMessage id="about.teamEditiont0" defaultMessage="" />;
    ...
    let learnMoreAnswer = (
      <div>
        ...
        <ExternalLink location="about_build_modal" href="https://nimbupani.ai">
          {"nimbupani.ai"}
        </ExternalLink>
      </div>
    );
    ...
    let learnMoreMattermost = (
      <div>
        <FormattedMessage
          ...
          defaultMessage="Nimbupani is built on the open-source Mattermost platform, customized to enhance collaboration and community engagement. We acknowledge and comply with Mattermost's GNU AGPL v3.0 and Apache License v2.0. Learn more at "
        />
        <ExternalLink
            ...
            <div>
              ...
              <div className="form-group less">
                <div data-testid="aboutModalVersion">
                  <FormattedMessage
                    id="about.version"
                    defaultMessage="Nimbupani Version:"
                  />
